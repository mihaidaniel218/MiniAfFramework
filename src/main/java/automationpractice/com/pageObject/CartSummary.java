...
public class CartSummary {
    ...
    public WebElement getCartSummUnitPrice(int numOfProduct) {
        return Utils.waitForElementPresence(driver, By.xpath("//table[@id='cart_summary']/tbody/tr[1]/td[@class='cart_unit']/span[@class='price']/span[@class='old-price']"), 30);
    }
    ...
    public WebElement getCartProceedBtnTwo() {
        return Utils.waitToBeClickable(driver, By.xpath("//a[@class='button btn btn-default standard-checkout button-medium']//span[contains(text(),'Proceed to checkout')]"),30);
    }
